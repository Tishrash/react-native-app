...
const styles = StyleSheet.create({
 container: { flex: 1, backgroundColor: '#f4f4f4' },
  ...
  storeInput: { borderWidth: 1, borderColor: '#ddd', borderRadius: 5, padding: 10, marginBottom: 15 },
  ...
  logoutText: { color: 'white', fontSize: 16, fontWeight: 'bold' },  modalContainer: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(0,0,0,0.5)' },
